...
module.exports.routes = {
  ...
  'put /api/v2/admin/users/:id/badge': 'AdminUserController.addBadge',
  'delete /api/v2/admin/users/:id/badge': 'AdminUserController.removeBadge',
  'post /api/v2/admin/users/:id/notify': 'AdminUserController.sendNotification',
